      ...
      {fabVisible && (
        ...
        >
          <a
            ...
            className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 shadow-lg shadow-emerald-500/25 transition-all hover:scale-105 hover:shadow-emerald-500/40 active:scale-95"
            aria-label="Contactar por WhatsApp"
          >
            <img src="/isotipo-mint.png" alt="WhatsApp" className="h-7 w-7 object-contain brightness-0 invert" width={28} height={28} />
