...
// Extended integration list - 60 total (6 rows x 10 columns)
const integrations = [
  // Row 1: Cloud (6) + Pagos (4)
  ...
  // Row 2: Comunicación (7) + Productividad (3)
  ...
  // Row 3: Productividad (4) + CRM (5) + Automatización (1)
  ...
  // Row 4: Automatización (3) + Email (4) + Database (3)
  ...
  // Row 5: Database (3) + E-commerce (4) + Desarrollo (3)
  ...
  // Row 6: Desarrollo (1) + Diseño (3) + IA (5) + Analytics (1)
  ...
  return (
    <section id="integraciones" ref={ref} className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        {/* Logos Grid - Perfect 10-column rectangle */}
        <motion.div
          layout
        ...
        >
          <AnimatePresence mode="popLayout">
            {filteredIntegrations.map((integration) => (
              ...
              >
                <IntegrationIcon name={integration.name} icon={integration.icon} />
