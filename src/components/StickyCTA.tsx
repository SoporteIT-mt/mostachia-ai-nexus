    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-20 left-0 right-0 z-40 md:hidden backdrop-blur-xl bg-[rgba(15,30,39,0.9)] border-t border-[rgba(115,215,203,0.1)] px-4 py-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))]"
        >
